...
M["format-to-feed"] = function(article, max_columns)
  ...
  return {("\240\159\173\189" .. string.rep("\226\150\148", max_columns) .. "\240\159\173\190"), (" ## " .. article.title), (" " .. article.description), (" \240\159\145\164" .. article.user.name .. " (" .. article.user.username .. ")"), "\226\150\143", (" \240\159\149\146 " .. article.reading_time_minutes .. " " .. get_plural(article.reading_time_minutes, "minute") .. " of reading time"), (" Tags: " .. tags_to_str(article.tag_list)), (" \240\159\146\149" .. tostring(article.positive_reactions_count) .. " \240\159\146\172" .. tostring(article.comments_count)), (" \240\159\147\134" .. article.readable_publish_date), "\226\150\143", ("\240\159\173\188" .. string.rep("\226\150\129", max_columns) .. "\240\159\173\191"), ""}
end
return M
